...
class Wp_Puskesmas {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wp_Puskesmas_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WP_PUSKESMAS_VERSION' ) ) {
			$this->version = WP_PUSKESMAS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-puskesmas';
	 ...
	 *
	 * - Wp_Puskesmas_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Puskesmas_i18n. Defines internationalization functionality.
	 * - Wp_Puskesmas_Admin. Defines all hooks for the admin area.
	 * - Wp_Puskesmas_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-puskesmas-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-puskesmas-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp-puskesmas-admin.php';
	 ...
	 *
	 * Uses the Wp_Puskesmas_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wp_Puskesmas_i18n();
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'carbon_fields_register_fields', $plugin_admin, 'crb_attach_wp_puskesmas_options' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp_Puskesmas_Loader    Orchestrates the hooks of the plugin.
	 */
